...
const FormSchema = z.object({
  ...
  weatherCondition: z.string().nonempty({ message: 'Weather condition is required' }),
          ...
          {step === 1 && (
            ...
            >
              <Card>
                ...
                <CardContent>
                  <FarmerSelection control={form.control} farmers={farmers || []} />
                </CardContent>
              </Card>
              <div className="flex justify-end mt-4">
                <Button type="button" onClick={nextStep} disabled={!selectedFarmer}>
                  Next
                </Button>
              </div>
            </motion.div>
